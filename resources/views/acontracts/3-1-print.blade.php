...
<body>
    <div class="container text-justify">
        <font face="Arial">
            ...
            <b><u>SEGUNDA: (OBJETO DEL CONTRATO).-</u></b> Al presente y con sujeción a la reglamentación adoptada, <b>PROEZA S.R.L.</b> de sus recursos propios concede, a favor del DEUDORun préstamo de dinero, por la suma de Bs. {{ $request->monto }}.- ({{ $request->montolit }} 00/100 BOLIVIANOS), y que dicho DEUDOR  se obliga a recibir y restituir conforme a las estipulaciones del presente contrato.
            <br>
