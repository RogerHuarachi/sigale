...
<head>
    ...
    <title>4.4-2021 MODELO-CONTRATO DE PRESTAMO CON PRENDA Y CUSTODIA SIN CODEUDOR - {{ $request->deudor }}</title>
    <!-- Theme style -->
...
<body>
    <div class="container text-justify">
        <font face="Arial">
            ...
            <br>
            <b><u>VIGÉSIMA SEGUNDA: (ACEPTACIÓN).-</u></b> Nosotros: <b>PROEZA S.R.L.</b>, legalmente representado por LUIS ALEJANDRO ARZE RICO con C.I. N° 3607626 CB en mérito al Poder N.º 517/2021 otorgado ante Notaria N.º47 a cargo de la Dra. Luz Angela Russel Fuentes, ahora como PODERDANTE de <b>{{ $request->encargado }}</b> con C.I.
            @if ($request->encargado == "GUALBERTO EDSSON COCA VARGAS")
                3748209 CB
            @else
                9452529 CB
