...
<body>
    <div class="container text-justify">
        <font face="Arial">
            ...
            <br>
            <b>PROEZA S.R.L.</b> podrá requerir datos e información necesarios para la o las inspecciones que se realicen, en cualquier momento y en la ocasión, forma y lugar que consideren convenientes y a simple aviso a dependientes o encargados de (los) <b>DEUDOR (ES)</b>.
            <br>
            ...
            <b><u>DECIMA SEXTA: (GASTOS EN CASO DE EJECUCION). -</u></b> Todos los gastos, relativos a la concesión del presente préstamo, serán de cargo y cuenta exclusiva del (los) <b>DEUDOR (ES)</b>. El presente documento y respectivo comprobante de desembolso servirá de título ejecutivo y dará lugar al cobro ejecutivo judicial respectivo, conforme a lo establecido por el Código Procesal Civil y la ya referida Ley N.º 1760. Para esta eventualidad, El (los) DEUDOR(ES) ratifica (n) el domicilio señalado en la cláusula Primera, como especial y convencional válido para efectos procesales.
            <br>
            ...
            <b><u>VIGECIMA SEGUNDA: (ACEPTACIÓN).-</u></b> Nosotros: <b>PROEZA S.R.L.</b>, legalmente representado por LUIS ALEJANDRO ARZE RICO con C.I. N° 3607626 CB en mérito al Poder N.º 517/2021 otorgado ante Notaria N.º47 a cargo de la Dra. Luz Angela Russel Fuentes, ahora como PODERDANTE de <b>{{ $request->encargado }}</b> con C.I.
            @if ($request->encargado == "GUALBERTO EDSSON COCA VARGAS")
                3748209 CB
            @else
                9452529 CB
            @endif
             quien ahora es APODERADO y cuenta con poder especial, suficiente y bastante para celebrar, firmar y ejecutar los contratos de préstamo de dinero que otorga <b>PROEZA S.R.L.</b>, en mérito al <b>poder No. 604/2021</b> otorgado por Notaria de Fe Pública No. 47 a cargo de la Dra. Luz Ángela Russel Fuentes de la ciudad de Cochabamba y {{ $request->deudor }}, {{ $request->codeudor }} como <b>DEUDOR (ES)</b>, respectivamente por la otra, manifestamos nuestra entera y absoluta conformidad con todas y cada una de las cláusulas y estipulaciones del presente contrato, obligándonos a su fiel y estricto cumplimiento, firmando en constancia de ello. Así mismo el presente documento, tendrá el valor legal establecido por el Art. 519 del Código Civil, en caso de no contar con el reconocimiento de firmas y rubricas por cualquier motivo o circunstancia.
            <br><br>
            <div class="text-center">
