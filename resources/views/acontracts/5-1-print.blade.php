...
<body>
    <div class="container text-justify">
        <font face="Arial">
            ...
            <b><u>VIGECIMA SEGUNDA: (ACEPTACIÓN). -</u></b> <b> Nosotros: PROEZA S.R.L.</b>, legalmente representado por LUIS ALEJANDRO ARZE RICO con C.I. N° 3607626 CB en merito al Poder N.º 517/2021 otorgado ante Notaria N.º47 a cargo de la Dra. Luz Angela Russel Fuentes, ahora como PODERDANTE de <b>{{ $request->encargado }}</b> con C.I.
            @if ($request->encargado == "GUALBERTO EDSSON COCA VARGAS")
                3748209 CB
            @else
                9452529 CB
