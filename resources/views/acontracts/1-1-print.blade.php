...
<body>
    <div class="container text-justify">
        <font face="Arial">
            ...
            <b><u>NOVENA: (CADUCIDAD Y DERECHOS DE ACELERACIÓN). -</u></b> Independientemente de la mora de (los) <b>DEUDOR (ES)</b> por incumplimiento de pago conforme lo previsto en la cláusula precedente, <b>PROEZA S.R.L.</b>  podrá de la misma manera y con iguales efectos, declarar la caducidad del término y declarar el monto total del préstamo y sus intereses y accesorios pendientes de pago, de plazo vencido, sumas líquidas y exigibles y en mora aunque el término no se encuentre vencido, y proceder a la cobranza judicial del préstamo intereses, accesorios, etc., sin necesidad de ninguna intimación o requerimiento judicial o extrajudicial y en la forma establecida para este efecto en la cláusula anterior, por cualquiera de las siguientes causas:
            <br>
            9.1.Incumplimiento de cualesquiera de las cláusulas o estipulaciones del presente contrato;
            <br>
            9.2. Disminución de la solvencia de (los) <b>DEUDOR (ES)</b> librada a la sola apreciación y criterio de <b>PROEZA S.R.L.</b>;
            <br>
            9.3. Solicitud de concurso preventivo o de quiebra, o de concurso voluntario o necesario de acreedores, promovida por el (los) <b>DEUDOR (ES)</b> o por terceros;
            <br>
            9.4. Disminución de las garantías otorgadas, o del patrimonio de (los) <b>DEUDOR (ES)</b>, o de su fuga, o la persecución judicial, embargo o secuestro de sus bienes;
            <br>
            9.5. Si el (los) <b>DEUDOR (ES)</b> en cualquier momento desconocieran la validez legal o ejecutabilidad de las obligaciones contraídas bajo el presente contrato; o cualquier parte del mismo o de cualquier documento otorgado de acuerdo al presente;
            <br>
            9.6. Si el (los) <b>DEUDOR (ES)</b> admitiere (n) su imposibilidad de pagar sus deudas a medida que las mismas vencen;
            <br>
            9.7. Por falsedad o encubrimiento de datos en la declaración de bienes o cualquier otra declaración o información presentada a <b>PROEZA S.R.L.</b>  por el (los) <b>DEUDOR (ES)</b> o cualquiera de sus fiadores.
            <br>
            9.8. Por no destinar precisamente el importe del préstamo a la finalidad para la que se ha solicitado.
            <br>
            9.9. En general cualquier acto de (los) <b>DEUDOR (ES)</b> y/o cualquier circunstancia que a criterio de <b>PROEZA S.R.L.</b>  pudiera poner en riesgo la total recuperación del crédito y demás obligaciones contraídas por el (los) <b>DEUDOR (ES)</b>.
            <br>
            ...
            <b><u>DÉCIMA SEGUNDA: (CASTIGO DEL PRÉSTAMO). -</u></b> El castigo de la obligación de (los) <b>DEUDOR (ES)</b> no extingue ni afecta los derechos <b>PROEZA S.R.L.</b>, para ejercer las acciones legales judiciales y extrajudiciales, con el propósito de la recuperación del monto adeudado. El reporte como crédito castigado procederá previa autorización de Gerencia y permanecerá hasta que la deuda sea cancelada en su totalidad. Entre tanto se reporte como deuda castigada el (los) <b>DEUDOR (ES)</b>, co<b>deudor (es)</b> y garante (s) no podrán ser sujetos de créditos de acuerdo a normativa vigente.
            <br>
            ...
            <br>
            Se deja clara constancia que el <b>SEGURO DE VIDA EN GRUPO ANUAL RENOVABLE A CAPITAL CONSTANTE</b> cubrirá el saldo total de la deuda DEL DEUDOR en PROEZA a la fecha del siniestro dentro los límites y condiciones establecidas en el Contrato de Seguros, al cual <b>PROEZA S.R.L.</b>   y <b>EL DEUDOR</b> declaran someterse. <b>EL BENEFICIARIO</b> del Seguro será <b>PROEZA S.R.L.</b>
            <br>
