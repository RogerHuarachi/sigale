...
<head>
    ...
    <title>3-2021 MODELO-CONTRATO DE PRESTAMO QUIROGRAFARIO CON CODEUDOR - {{ $request->deudor }}</title>
    <!-- Theme style -->
...
<body>
    <div class="container text-justify">
        <font face="Arial">
            ...
            <b><u>SEGUNDA: (OBJETO DEL CONTRATO).-</u></b> Al presente y con sujeción a la reglamentación adoptada, <b>PROEZA S.R.L.</b> de sus recursos propios concede, a favor del DEUDOR/A un préstamo de dinero, por la suma de Bs. {{ $request->monto }}.- ({{ $request->montolit }} 00/100 BOLIVIANOS), y que dicho DEUDOR/A se obliga a recibir y restituir conforme a las estipulaciones del presente contrato.
            <br>
            ...
            <b><u>DÉCIMA SEGUNDA: (CASTIGO DEL PRÉSTAMO). -</u></b> El castigo de la obligación de, el (los) <b>DEUDOR (ES)</b> no extingue ni afecta los derechos <b>PROEZA S.R.L.</b> para ejercer las acciones legales judiciales y extrajudiciales con el propósito de la recuperación del monto adeudado. El reporte como crédito castigado procederá previa autorización de Gerencia y permanecerá hasta que la deuda sea cancelada en su totalidad. Entre tanto se reporte como deuda castigada el (los) <b>DEUDOR (ES)</b>, co<b>deudor (es)</b> y garante (s) no podrán ser sujetos de créditos de acuerdo a normativa vigente.
            <br>

            <b><u>DÉCIMA TERCERA: (CAPACIDAD Y PERSONERÍA). -</u></b> El (los) <b>DEUDOR (ES)</b> y codeudores reconocen expresamente la personalidad jurídica <b>PROEZA S.R.L.</b>, y así mismo las facultades jurídicas y capacidad de sus personeros legales, motivo por el cual han celebrado el presente contrato de préstamo.
            <br>
            ...
            <b><u>DÉCIMA QUINTA: (OBLIGACIONES ESPECIALES). -</u></b> EL DEUDOR queda forzado al cumplimiento de las siguientes obligaciones especiales:
            <br>
