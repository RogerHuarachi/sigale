...
<head>
    ...
    <title>5.5.5-2021 MODELO- CONTRATO DE PRESTAMO CON GARANTE PERSONAL Y PRENDARIA DE BIENES SIN CODEUDOR Y SIN CO GARANTE - {{ $request->deudor }}</title>
    <!-- Theme style -->
...
<body>
    <div class="container text-justify">
        <font face="Arial">
            ...
            <br>
            1.2.	{{ $request->deudor }} con C.I. No. {{ $request->deudorci }}, {{ $request->deudorec }}, {{ $request->deudoro }} con domicilio en la {{ $request->domicilio }} zona {{ $request->zona }} de esta ciudad, mayor (es) de edad y hábil (es) por derecho, en adelante denominado (s) el (los) <b>DEUDOR (ES)</b>.
            <br>

            <b><u>SEGUNDA: (OBJETO DEL CONTRATO).-</u></b> Al presente y con sujeción a la reglamentación adoptada, <b>PROEZA S.R.L.</b> de sus recursos propios concede, a favor del (los) <b>DEUDOR (ES)</b> un préstamo de dinero, por la suma de Bs. {{ $request->monto }}.- ({{ $request->montolit }} 00/100 BOLIVIANOS), y que dicho DEUDOR/A se obliga a recibir y restituir conforme a las estipulaciones del presente contrato.
            <br>

            <b><u>TERCERA: (DESEMBOLSO). -</u></b> El préstamo concedido quedará perfeccionado mediante un solo desembolso, acreditado por la respectiva papeleta de abono y/o comprobante de transferencia o entrega del efectivo por el monto total acordado en el presente documento. Dicho desembolso será realizado por <b>PROEZA S.R.L.</b> en bolivianos, previo cumplimiento por el (los) <b>DEUDOR (ES)</b> de todos los requisitos y condiciones establecidos al efecto.
            <br>

            <b><u>CUARTA: (DESTINO DE PRESTAMO Y SUPERVISION). -</u></b>  El préstamo es concedido por <b>PROEZA S.R.L.</b> para CONSUMO (LIBRE DISPONIBILIDAD), con exclusión de cualquier otro uso o destino. En caso de que los fondos sean destinados a fines distintos de los especificados, sin que hubiere mediado previo acuerdo con <b>PROEZA S.R.L.</b>, éste podrá dar por vencido el plazo del préstamo y su monto insoluto será inmediatamente exigible, sin perjuicio de las demás responsabilidades en que el deudor pueda haber incurrido.
            <br>
            <b>PROEZA S.R.L.</b> podrá requerir datos e información necesarios para la o las inspecciones que se realicen, en cualquier momento y en el lugar que consideren convenientes y a simple aviso a dependientes o encargados del (de los) <b>DEUDOR (ES)</b>. Así como cualquier información relacionada con la situación del (de los) <b>DEUDOR (ES)</b>.
            <br>

            <b><u>QUINTA: (PLAZO Y AMORTIZACIONES).-</u></b> El plazo por el cual <b>PROEZA S.R.L.</b> concede el presente préstamo es de {{ $request->plazo }} meses computables a partir del desembolso del préstamo, y mediante el pago de “{{ $request->cuotas }}” cuotas consecutivas mediante amortizaciones cada “{{ $request->frecuencia }}” días. Los montos, el cronograma, así como el total acumulado de los pagos del servicio del crédito constarán en plan de pagos que es de conocimiento del (de los) <b>DEUDOR (ES)</b> y que ha sido entregado en mano propia a el (los) <b>DEUDOR (ES)</b>. El plazo se estipula a favor de <b>PROEZA S.R.L.</b> Al vencimiento del plazo señalado, el préstamo y cualquier saldo deudor de capital, intereses, accesorios y todo lo demás aplicables al préstamo deberán quedar pagado en su integridad. Si alguna de las fechas de amortización cayese en día inhábil, el vencimiento correspondiente se producirá el día hábil siguiente.
            <br>
            ...
            <br>
            6.1. Una tasa de interés fija nominal anual del “36 %” (TREINTA Y SEIS POR CIENTO), sobre saldos deudores de capital desde la fecha de desembolso del préstamo. A los efectos del cálculo de intereses por periodos inferiores a un año, contablemente se considerará que el año tiene trescientos sesenta (360) días.
            <br>
            ...
            <br>
            10.1. En igual garantía de todas las obligaciones del (de los) <b>DEUDOR (ES)</b> bajo el presente contrato, se constituye en garante solidario mancomunado e indivisible el señor (es): {{ $request->garantea }} con C.I. Nº {{ $request->garantecia }}, {{ $request->garanteeca }}, {{ $request->garanteoa }} con domicilio en la {{ $request->garantedomi }}   zona {{ $request->garantezona }} de esta ciudad, mayor (es) de edad, hábil (es) por derecho, quien garantiza el fiel cumplimiento de la presente obligación con todos sus bienes habidos y por haber, aceptando para sí todos los términos, condiciones, cláusulas y estipulaciones establecidas en el presente contrato, obligándose al pago de la deuda y demás obligaciones como el (los) propio  (s) <b>DEUDOR (ES)</b> y en forma incondicional e irrestricta, constituyéndose como si fuera principal y llano pagador de todas las obligaciones, capital, intereses y demás accesorios aplicables, relativos y emergentes, renunciando de su parte a los beneficios de excusión, división y otros beneficios legales.
            <br>
            10.2. Prenda con desplazamiento de los bienes muebles sobre los cuales declara (n) ser único (s) y legítimo (s) propietarios, detalle establecido en formulario de avaluó de mercadería y/ o maquinaria y/o equipo, que cursa en carpeta de crédito y mismo que forma parte integrante e indivisible del presente contrato.
            <br>
            Se designa depositario gratuito de la prenda descrita a el (los) <b>DEUDOR (ES)</b>, quien (es) declara (n) recibirla a su entera satisfacción en la (s) siguiente (s) dirección (es):  {{ $request->direccionmer }} zona {{ $request->zonamer }} constituyéndose éste el lugar del depósito. El (los) <b>DEUDOR (ES)</b> y depositario (s) gratuito (s) de la prenda queda (n) bajo la guarda, custodia y conservación de ésta, asumiendo para sí todas y cada una de las obligaciones establecidas por ley, obligándose a no cambiar de ubicación, gravar, ceder, vender o de cualquier modo disponer en todo o en parte, salvo que <b>PROEZA S.R.L.</b> expresamente lo autorice por escrito y en tal caso, bajo las condiciones que éste establezca en resguardo de sus derechos bajo el presente contrato. Asimismo, deberá (n) dar aviso a <b>PROEZA S.R.L.</b> sobre cualquier cambio que se produjere respecto de la conservación, ubicación, pérdida, daños o cualquier riesgo que pudiere sufrir la prenda en garantía. El (los) <b>DEUDOR (ES)</b> faculta (n) expresamente a <b>PROEZA S.R.L.</b> para exigir la exhibición y entrega de la prenda en cualquier momento mientras la deuda esté pendiente de pago. <b>PROEZA S.R.L.</b> podrá en cualquier tiempo, y a sola petición escrita, sustituir al depositario de la prenda mientras exista la deuda, al igual que solicitar el cambio de depositario y el lugar del depósito, para lo que el (los) <b>DEUDOR (ES)</b> y depositarios deberán permitir el ingreso y entrega de la garantía al depositario que se designe por parte <b>PROEZA S.R.L.</b>
            <br>
            En caso de incumplimiento a lo establecido en esta cláusula se procederá a lo estipulado en la cláusula octava del presente documento.
            <br>
            ...
            <b><u>DÉCIMA SEGUNDA: (CASTIGO DEL PRÉSTAMO). -</u></b> El castigo de la obligación de, el (los) <b>DEUDOR (ES)</b> no extingue ni afecta los derechos de <b>PROEZA S.R.L.</b> para ejercer las acciones legales judiciales y extrajudiciales con el propósito de la recuperación del monto adeudado. El reporte como crédito castigado procederá previa autorización de Gerencia y permanecerá hasta que la deuda sea cancelada en su totalidad. Entre tanto se reporte como deuda castigada el (los) <b>DEUDOR (ES)</b>, co<b>deudor (es)</b> y garante (s) no podrán ser sujetos de créditos de acuerdo a normativa vigente.
            <br>
            ...
            <b>
                @if ($request->regional== "Cochabamba")
                    CALLE OBISPO ANAYA #340 EDIFICIO SION OFICINA 2B ZONA CALA CALA.
                @elseif ($request->regional == "Santa Cruz")
                    Calle Rene Moreno, Esquina Pari, Edificio Don Alcides, Planta Alta, local 203 de la ciudad de Santa Cruz.
                @else
                    Rio Seco, Av. Juan Pablo II entre Luis Espinal, Edificio San Francisco – 1er piso Dpto. A4.
                @endif

            </b>
            En caso de cambio de domicilio, las partes están en la obligación de comunicar en forma inmediata este hecho a <b>PROEZA S.R.L.</b> caso contrario se reputará como domicilio vigente el señalado en conformidad al Art. 30 del Código Civil.
            <br>
            ...
            <div class="row">
                <div class="col-6">
                    {{ $request->deudor }}
                    <br>
                    <b>Como DEUDOR (ES) y DEPOSITARIO (S) GRATUITO (S).</b>
                </div>
            </div>
            <br><br><br><br><br><br>
            <div class="row">
