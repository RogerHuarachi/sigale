...
<head>
    ...
    <title>2.2-2021 MODELO-CONTRATO DE PRESTAMO CON PRENDA DE MERCADERIA SIN CODEUDOR - {{ $request->deudor }}</title>
    <!-- Theme style -->
...
<body>
    <div class="container text-justify">
        <font face="Arial">
            ...
            <b><u>DECIMA SEXTA: (GASTOS EN CASO DE EJECUCION). -</u></b> Todos los gastos, relativos a la concesión del presente préstamo, serán de cargo y cuenta exclusiva del (los) <b>DEUDOR (ES)</b>. El presente documento y respectivo comprobante de desembolso servirá de título ejecutivo y dará lugar al cobro ejecutivo judicial respectivo, conforme a lo establecido por el Código Procesal Civil y la ya referida Ley N.º 1760. Para esta eventualidad, El (LOS) <b>DEUDOR (ES)</b> ratifica el domicilio señalado en la cláusula Primera, como especial y convencional válido para efectos procesales.
            <br>
