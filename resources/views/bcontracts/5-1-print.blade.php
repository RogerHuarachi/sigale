...
<head>
    ...
    <title>5.5-2021 MODELO- CONTRATO DE PRESTAMO CON GARANTE PERSONAL Y PRENDARIA DE BIENES SIN CODEUDOR Y CON CO GARANTE - {{ $request->deudor }}</title>
    <!-- Theme style -->
