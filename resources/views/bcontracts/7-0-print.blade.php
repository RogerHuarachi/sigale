...
<head>
    ...
    <title>7-2021 MODELO-CONTRATO DE PRESTAMO CON GARANTE PERSONAL CON CODEUDOR CON CO GARANTE - {{ $request->deudor }}</title>
    <!-- Theme style -->
