...
<head>
    ...
    <title>6.6.6 -2021 MODELO- CONTRATO DE PRESTAMO CON GARANTE PERSONAL Y PRENDARIA DE DOCUMENTACION SIN CODEUDOR Y SIN CO GARANTE - {{ $request->deudor }}</title>
    <!-- Theme style -->
...
<body>
    <div class="container text-justify">
        <font face="Arial">
            ...
            <b><u>DECIMA QUINTA: (OBLIGACIONES ESPECIALES). -</u></b> EL DEUDOR queda reatado al cumplimiento de las siguientes obligaciones especiales:
            <br>
