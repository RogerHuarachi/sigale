...
<head>
    ...
    <title>9-2021 MODELO-CONTRATO DE REPROGRAMACIÓN CON PRENDA DE MERCADERIA CON CO DEUDOR - {{ $request->deudor }}</title>
    <!-- Theme style -->
