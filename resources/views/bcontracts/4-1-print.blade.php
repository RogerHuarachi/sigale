...
<body>
    <div class="container text-justify">
        <font face="Arial">
            ...
            <b><u>TERCERA: (DESEMBOLSO). -</u></b> El préstamo concedido quedará perfeccionado mediante un solo desembolso, acreditado por la respectiva papeleta de abono y/o comprobante de transferencia o entrega del efectivo por el monto total acordado en el presente documento. Dicho desembolso será realizado por <b>PROEZA S.R.L.</b> en bolivianos, previo cumplimiento por el DEUDOR/A de todos los requisitos y condiciones establecidos al efecto.
            <br>
            ...
            <br>
            10.1. Prenda con desplazamiento de los bienes muebles sobre los cuales declara (n) ser único (s) y legítimo (s) propietarios, detalle establecido en el formulario de avaluó de mercadería y/ o maquinaria y/o equipo, que cursa en carpeta de crédito y mismo que forma parte integrante e indivisible del presente contrato.
            <br>
            ...
            <br>
            Por otra parte, el (los) <b>DEUDOR (ES)</b> con la finalidad de evidenciar solvencia patrimonial entregan en custodia a <b>PROEZA S.R.L.</b>, (constituyéndose en anexo del presente contrato) los siguientes documentos que se detallan a continuación:
            <br>
            <ul class="m-0">
            ...
            <b><u>VIGÉSIMA SEGUNDA: (ACEPTACIÓN).-</u></b> Nosotros: <b>PROEZA S.R.L.</b>, legalmente representado por LUIS ALEJANDRO ARZE RICO con C.I. N° 3607626 CB en mérito al Poder N.º 517/2021 otorgado ante Notaria N.º47 a cargo de la Dra. Luz Angela Russel Fuentes de la ciudad de Cochabamba y {{ $request->deudor }} como <b>DEUDOR (ES)</b>, por la PRENDA y como DEPOSITARIO (S) GRATUITO (S), respectivamente por la otra, manifestamos nuestra entera y absoluta conformidad con todas y cada una de las cláusulas y estipulaciones del presente contrato, obligándonos a su fiel y estricto cumplimiento, firmando en constancia de ello. Así mismo el presente documento, tendrá el valor legal establecido por el Art. 519 del Código Civil, en caso de no contar con el reconocimiento de firmas y rubricas por cualquier motivo o circunstancia.
            <br><br>
            <div class="text-center">
