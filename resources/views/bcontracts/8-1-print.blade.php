...
<head>
    ...
    <title>8.8 -2021 MODELO-CONTRATO DE REPROGRAMACIÓN DE CRÉDITO CON GARANTE PERSONAL SIN CO DEUDOR Y CO GARANTE - {{ $request->deudor }}</title>
    <!-- Theme style -->
