...
<head>
    ...
    <title>8.8.8  -2021 MODELO-CONTRATO DE REPROGRAMACIÓN DE CRÉDITO CON GARANTE PERSONAL SIN CO DEUDOR Y SIN CO GARANTE - {{ $request->deudor }}</title>
    <!-- Theme style -->
...
<body>
    <div class="container text-justify">
        <font face="Arial">
            ...
            <b><u>SEGUNDA: (OBJETO DEL CONTRATO). -</u></b> Al presente y con sujeción a la reglamentación adoptada, <b>PROEZA S.R.L.</b>, concede, a favor del(los) <b>DEUDOR (ES)</b> una REPROGRAMACIÓN DE CRÉDITO, y que dicho (s) <b>DEUDOR (ES)</b> se obliga a cumplir y restituir conforme a las estipulaciones del presente contrato.
            <br>
            ...
            <b><u>CUARTA: (REPROGRAMACIÓN).-</u></b> Ambas partes han convenido la reestructuración del mencionado préstamo, de acuerdo a las cláusulas del presente contrato, en cuyo efecto <b>PROEZA S.R.L.</b>, concede en favor del (los) <b>DEUDOR (ES)</b> un plazo de {{ $request->plazo }} el mismo que  se considerará para todos los efectos obligacionales como el plazo real y efectivo, la misma que, el DEUDOR declaran conocer y en plena conformidad, a tiempo de la suscripción del presente documento, el cual se reputa como suficiente, por lo que el DEUDOR se obliga con <b>PROEZA S.R.L.</b> por el monto total del préstamo en el plazo acorado y demás obligaciones inherentes, derivadas y emergentes.
            <br>
            ...
            <br>
            Por otra parte, y de manera especial el (los) <b>DEUDOR (ES)</b> acuerda (n) constituir y constituye (n) a favor <b>PROEZA S.R.L.</b> la (s) siguiente (s) garantías expresa (s):
            <br>
