...
<head>
    ...
    <title>9.9 -2021 MODELO-CONTRATO DE REPROGRAMACIÓN CON PRENDA DE MERCADERIA SIN CO DEUDOR - {{ $request->deudor }}</title>
    <!-- Theme style -->
...
<body>
    <div class="container text-justify">
        <font face="Arial">
            ...
            Por el presente, se celebra un contrato de reprogramación de crédito, mismo que al simple reconocimiento de firmas y rubricas ante Autoridad competente surtirá los efectos legales de documento público, de conformidad a las siguientes cláusulas:
            <br>
            ...
            <b><u>SEGUNDA: (OBJETO DEL CONTRATO). -</u></b> Al presente y con sujeción a la reglamentación adoptada, <b>PROEZA S.R.L.</b>, concede, a favor del DEUDOR/A una REPROGRAMACIÓN DE CRÉDITO, y que dicho DEUDOR/A se obliga a cumplir y restituir conforme a las estipulaciones del presente contrato.
            <br>

            <b><u>TERCERA: (ANTECEDENTES). -</u></b> <b>PROEZA S.R.L.</b>, concedió en favor del (los) <b>DEUDOR (ES)</b>, un préstamo de dinero, por la suma de Bs. {{ $request->monto }}.- ({{ $request->montolit }} 00/100 BOLIVIANOS), mencionado contrato de préstamo de dinero de fecha {{ $request->fechaprin}} en el cual el(los) <b>DEUDOR (ES)</b> nombrados declaran haber recibido en su integridad a su entera satisfacción y conformidad, a tiempo de la suscripción del precitado contrato, el cual se reputa como suficiente recibo y constancia de recepción del dinero prestado, por lo que se constituye como <b>DEUDOR (ES)</b> por el monto total del préstamo y demás obligaciones inherentes, derivadas y emergentes. El préstamo, fue concedido por un plazo libremente convenido de {{ $request->plazoini }} meses, dentro de los cuales, dicha obligación debió haber sido cancelada, estableciéndose a la fecha un saldo deudor a capital de Bs. {{ $request->saldodeu }}.- ({{ $request->saldodeulit }} 00/100 BOLIVIANOS)
            <br>

            <b><u>CUARTA: (REPROGRAMACIÓN).-</u></b> Ambas partes han convenido la Reestructuración del mencionado préstamo, de acuerdo a las cláusulas del presente contrato, en cuyo efecto <b>PROEZA S.R.L.</b>, concede en favor del DEUDOR un plazo de {{ $request->plazo }} el mismo que  se considerará para todos los efectos obligacionales como el plazo real y efectivo, la misma que, el DEUDOR declaran conocer y en plena conformidad, a tiempo de la suscripción del presente documento, el cual se reputa como suficiente, por lo que el/los <b>DEUDOR (ES)</b> se obliga (n) con <b>PROEZA S.R.L.</b> por el monto total del préstamo en el plazo acorado y demás obligaciones inherentes, derivadas y emergentes,  obligaciones que se encuentran en el nuevo plan de pagos.
            <br>
            ...
            <b><u>DÉCIMA SEGUNDA: (CASTIGO DEL PRÉSTAMO). -</u></b> El castigo de la obligación de, el (los) <b>DEUDOR (ES)</b> no extingue ni afecta los derechos de <b>PROEZA S.R.L.</b> para ejercer las acciones legales judiciales y extrajudiciales para la recuperación del monto adeudado. El reporte como crédito castigado procederá previa autorización de Gerencia y permanecerá hasta que la deuda sea cancelada en su totalidad. Entre tanto se reporte como deuda castigada el (los) <b>DEUDOR (ES)</b>, co<b>deudor (es)</b> y garante (s) no podrán ser sujetos de créditos de acuerdo a normativa vigente.
            <br>
            ...
            <b><u>VIGECIMA PRIMERA:(ACEPTACIÓN).-</u></b> Nosotros: <b>PROEZA S.R.L.</b>, legalmente representado por LUIS ALEJANDRO ARZE RICO con C.I. N° 3607626 CB en merito al Poder N.º 517/2021 otorgado ante Notaria N.º47 a cargo de la Dra. Luz Angela Russel Fuentes de la ciudad de Cochabamba por una parte, y {{ $request->deudor }}, como <b>DEUDOR (ES)</b>, respectivamente por la otra, manifestamos nuestra entera y absoluta conformidad con todas y cada una de las cláusulas y estipulaciones del presente contrato, obligándonos a su fiel y estricto cumplimiento, firmando en constancia de ello. Así mismo el presente documento, tendrá el valor legal establecido por el Art. 519 del Código Civil, en caso de no contar con el reconocimiento de firmas y rubricas por cualquier motivo o circunstancia.
            <br><br>
            <div class="text-center">
