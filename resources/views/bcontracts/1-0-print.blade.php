...
<body>
    <div class="container text-justify">
        <font face="Arial">
            ...
            <br>
            1.2.	{{ $request->deudor }} con C.I. N.º {{ $request->deudorci }}, {{ $request->deudorec }}, {{ $request->deudoro }} y  {{ $request->codeudor }} con C.I. N.º {{ $request->codeudorci }}, {{ $request->codeudorec }}, {{ $request->codeudoro }} ambos con domicilio en la {{ $request->domicilio }}  zona {{ $request->zona }}, de esta ciudad, mayor (es) de edad y hábil (es) por derecho, en adelante denominado (s) el (los) <b>DEUDOR (ES)</b>.
            <br>
            ...
            <b><u>DÉCIMA PRIMERA:</u></b> (DERECHOS DEL DEUDOR). - El (los) <b>DEUDOR (ES)</b> tendrá (n) los siguientes derechos:
            <br>
