...
<head>
    ...
    <title>2-2021 MODELO-CONTRATO DE PRESTAMO CON PRENDA DE MERCADERIA CON CODEUDOR - {{ $request->deudor }}</title>
    <!-- Theme style -->
...
<body>
    <div class="container text-justify">
        <font face="Arial">
            ...
            <br>
            6.2. En caso de mora, la tasa de interés moratorio, que se aplicará conforme prevé el artículo 1334 del Código de Comercio con relación al art.1326 del mismo cuerpo de ley, es la tasa de interés corriente pactada, a la cual se recargará con el interés penal establecido para préstamos financieros por el Decreto Supremo No.28166 de 17 de mayo de 2005, modificado por el Decreto Supremo N.º 0530 de 02 de junio de 2010.
            <br>
            ...
            <b><u>DÉCIMA SEGUNA: (CASTIGO DEL PRÉSTAMO). -</u></b> El castigo de la obligación de, el (los) <b>DEUDOR (ES)</b> no extingue ni afecta los derechos de <b>PROEZA S.R.L.</b> para ejercer las acciones legales judiciales y extrajudiciales con el propósito de la recuperación del monto adeudado. El reporte como crédito castigado procederá previa autorización de Gerencia y permanecerá hasta que la deuda sea cancelada en su totalidad. Entre tanto se reporte como deuda castigada el (los) <b>DEUDOR (ES)</b>, co<b>deudor (es)</b> y garante (s) no podrán ser sujetos de créditos de acuerdo a normativa vigente.
            <br>
            ...
            <b><u>DECIMA SEXTA: (GASTOS EN CASO DE EJECUCION). -</u></b> Todos los gastos, relativos a la concesión del presente préstamo, serán de cargo y cuenta exclusiva del (los) <b>DEUDOR (ES)</b>. El presente documento y respectivo comprobante de desembolso servirá de título ejecutivo y dará lugar al cobro ejecutivo judicial respectivo, conforme a lo establecido por el Código Procesal Civil y la ya referida Ley N.º 1760. Para esta eventualidad, EL DEUDOR/A ratifica el domicilio señalado en la cláusula Primera, como especial y convencional válido para efectos procesales.
            <br>

            <b><u>DECIMA SEPTIMA: (CESIÓN DE CRÉDITO).-</u></b> EL (LOS) <b>DEUDOR (ES)</b> autoriza en forma expresa a <b>PROEZA S.R.L.</b>, a ceder, subrogar y/o transferir a cualquier título el derecho de crédito emergente del presente contrato de préstamo a favor de terceros sin necesidad de aceptación de ninguno de ellos y mucho menos su intervención en los contratos que suscriba <b>PROEZA S.R.L.</b> con terceros, siendo suficiente la información que proporcione <b>PROEZA S.R.L.</b> a su elección, antes o después de la cesión subrogación y/o transferencia.
            <br>

            <b><u>DECIMA OCTAVA: (AUTORIZACIÓN PARA INVESTIGACIÓN E INCORPORACIÓN DE ANTECEDENTES CREDITICIOS). -</u></b> EL DEUDOR, autoriza expresa y plenamente a <b>PROEZA S.R.L.</b> a efectuar en cualquier momento la investigación de sus antecedentes crediticios, en cualquier entidad sea pública o privada y/o en cualquier otra fuente que <b>PROEZA S.R.L.</b> estime conveniente y necesaria.
            <br>
            Así mismo, EL DEUDOR/A autorizan expresamente a <b>PROEZA S.R.L.</b> a incorporar los datos crediticios y otras cuentas por pagar de carácter económico, financiero y comercial derivados de la relación con <b>PROEZA S.R.L.</b> en la base de datos de propiedad de los Burós de información crediticia que cuenten con licencia de funcionamiento del Organismo de Supervisión.
            <br>
            ...
            <b><u>VIGECIMA SEGUNDA: (ACEPTACIÓN).-</u></b> Nosotros: <b>PROEZA S.R.L.</b>, legalmente representado por LUIS ALEJANDRO ARZE RICO con C.I. N° 3607626 CB en mérito al Poder N.º 517/2021 otorgado ante Notaria N.º47 a cargo de la Dra. Luz Angela Russel Fuentes de la ciudad de Cochabamba y {{ $request->deudor }}, {{ $request->codeudor }} como <b>DEUDOR (ES)</b>, respectivamente por la otra, manifestamos nuestra entera y absoluta conformidad con todas y cada una de las cláusulas y estipulaciones del presente contrato, obligándonos a su fiel y estricto cumplimiento, firmando en constancia de ello. Así mismo el presente documento, tendrá el valor legal establecido por el Art. 519 del Código Civil, en caso de no contar con el reconocimiento de firmas y rubricas por cualquier motivo o circunstancia.
            <br><br>
            <div class="text-center">
            ...
            <div class="row">
                <div class="col-6">
                    {{ $request->deudor }}
                    <br>
                    <b>Como DEUDOR (ES), por la PRENDA y como DEPOSITARIO GRATUITO.</b>
                </div>
                <div class="col-6">
                    {{ $request->codeudor }}
                </div>
