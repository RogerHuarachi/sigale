...
<head>
    ...
    <title>1.1-2021 MODELO-CONTRATO DE PRESTAMO CON PRENDA DOCUMENTAL SIN CODEUDOR - {{ $request->deudor }}</title>
    <!-- Theme style -->
...
<body>
    <div class="container text-justify">
        <font face="Arial">
            ...
            <br>
            1.1.	<b>PROEZA S.R.L.</b>, institución legalmente constituida, con Matrícula de Comercio N.º 371063 otorgada por FUNDEMPRESA y N.º de NIT 382166027 en lo sucesivo simplemente “<b>PROEZA S.R.L.</b>”.
            <br>
            1.2.	{{ $request->deudor }} con C.I. N.º {{ $request->deudorci }}, {{ $request->deudorec }}, {{ $request->deudoro }} con domicilio en la {{ $request->domicilio }}  zona {{ $request->zona }}, de esta ciudad, mayor (es) de edad y hábil (es) por derecho, en adelante denominado (s) el (los) <b>DEUDOR (ES)</b>.
            <br>

            <b><u>SEGUNDA: (OBJETO DEL CONTRATO).-</u></b> Al presente y con sujeción a la reglamentación adoptada, <b>PROEZA S.R.L.</b> de sus recursos propios concede, a favor de (los) <b>DEUDOR (ES)</b> un préstamo de dinero, por la suma de Bs. {{ $request->monto }}.- ({{ $request->montolit }} 00/100 BOLIVIANOS), y que dicho <b>DEUDOR (ES)</b> se obliga a recibir y restituir conforme a las estipulaciones del presente contrato.
            <br>
            ...
            <b><u>DÉCIMA SEGUNDA: (CASTIGO DEL PRÉSTAMO). -</u></b> El castigo de la obligación del (de los) <b>DEUDOR (ES)</b> no extingue ni afecta los derechos <b>PROEZA S.R.L.</b>, para ejercer las acciones legales judiciales y extrajudiciales, con el propósito de la recuperación del monto adeudado. El reporte como crédito castigado procederá previa autorización de Gerencia y permanecerá hasta que la deuda sea cancelada en su totalidad. Entre tanto se reporte como deuda castigada el (los) <b>DEUDOR (ES)</b>, co<b>deudor (es)</b> y garante (s) no podrán ser sujetos de créditos de acuerdo a normativa vigente.
            <br>

            <b><u>DÉCIMA TERCERA: (CAPACIDAD Y PERSONERÍA). -</u></b> El (los) <b>DEUDOR (ES)</b> y codeudores reconocen expresamente la personalidad jurídica de <b>PROEZA S.R.L.</b>, así mismo de las facultades jurídicas y capacidad de sus personeros legales, motivo por el cual han celebrado el presente contrato de préstamo.
            <br>
            ...
            <b><u>DECIMA SEXTA: (GASTOS EN CASO DE EJECUCION). -</u></b> Todos los gastos, relativos a la concesión del presente préstamo, serán de cargo y cuenta exclusiva del (los) <b>DEUDOR (ES)</b>. El presente documento y respectivo comprobante de desembolso servirá de título ejecutivo y dará lugar al cobro ejecutivo judicial respectivo, conforme a lo establecido por el Código Procesal Civil y la ya referida Ley N.º 1760. Para esta eventualidad, El (los) <b>DEUDOR (ES)</b> ratifica(n) el domicilio señalado en la cláusula Primera, como especial y convencional válido para efectos procesales.
            <br>
            ...
            <b><u>DECIMA OCTAVA: (AUTORIZACION PARA INVESTIGACIÓN E INCORPORACIÓN DE ANTECEDENTES CREDITICIOS). -</u></b> El (los) <b>DEUDOR (ES)</b>, autoriza expresa y plenamente a <b>PROEZA S.R.L.</b>  a efectuar en cualquier momento la investigación de sus antecedentes crediticios, en cualquier entidad sea pública o privada y/o en cualquier otra fuente que <b>PROEZA S.R.L.</b>  estime conveniente y necesaria.
            <br>
            Así mismo, El (los) <b>DEUDOR (ES)</b> autoriza(n) expresamente a <b>PROEZA S.R.L.</b>  a incorporar los datos crediticios y otras cuentas por pagar de carácter económico, financiero y comercial derivados de la relación con <b>PROEZA S.R.L.</b> en la base de datos de propiedad de los Burós de información crediticia que cuenten con licencia de funcionamiento del Organismo de Supervisión.
            <br>
            ...
            <br>
            Se deja clara constancia que el <b>SEGURO DE VIDA EN GRUPO ANUAL RENOVABLE A CAPITAL CONSTANTE</b> cubrirá el saldo total de la deuda DEL DEUDOR en PROEZA a la fecha del siniestro dentro los límites y condiciones establecidas en el Contrato de Seguros, al cual <b>PROEZA S.R.L.</b>   y EL DEUDOR declaran someterse.  EL BENEFICIARIO del Seguro será <b>PROEZA S.R.L.</b>
            <br>
