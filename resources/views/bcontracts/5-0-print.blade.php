...
<head>
    ...
    <title>5-2021 MODELO- CONTRATO DE PRESTAMO CON GARANTE PERSONAL Y PRENDARIA DE BIENES CON CODEUDOR Y CO GARANTE - {{ $request->deudor }}</title>
    <!-- Theme style -->
