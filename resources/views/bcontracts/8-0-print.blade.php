...
<head>
    ...
    <title>8-2021 MODELO-CONTRATO DE REPROGRAMACIÓN DE CRÉDITO CON GARANTE PERSONAL CON CO DEUDOR Y CO GARANTE - {{ $request->deudor }}</title>
    <!-- Theme style -->
