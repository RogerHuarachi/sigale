...
<head>
    ...
    <title>7.7.7.  -2021 MODELO-CONTRATO DE PRESTAMO CON GARANTE PERSONAL SIN CODEUDOR Y SIN CO GARANTE - {{ $request->deudor }}</title>
    <!-- Theme style -->
...
<body>
    <div class="container text-justify">
        <font face="Arial">
            ...
            <br>
            1.2.	{{ $request->deudor }} con C.I. No. {{ $request->deudorci }}, {{ $request->deudorec }}, {{ $request->deudoro }} ambos con domicilio en la {{ $request->domicilio }} zona {{ $request->zona }} de esta ciudad, mayor (es) de edad y hábil (es) por derecho, en adelante denominado (s) el (los) <b>DEUDOR (ES)</b>.
            <br>
            ...
            <b><u>DECIMA QUINTA: (OBLIGACIONES ESPECIALES). -</u></b> EL(LOS) <b>DEUDOR (ES)</b> queda forzado al cumplimiento de las siguientes obligaciones especiales:
            <br>
